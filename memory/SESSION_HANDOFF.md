...
- `1.3.0-beta.7` 将控制面板统一命名为“板卡资源”，并明确 LCD 是“外接 H8 LCD/OLED 接口”；资源启用标记和底边文字布局保持不变。
- 正在等待用户检查板卡资源术语、底边文字贴边效果和 Flash/LCD 等资源启停角标。已有工程不会自动补开 BSL，可通过“恢复模板初始配置”验证新默认。
