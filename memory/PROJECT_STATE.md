...
- 当前正式版本：`1.0.1`
- 当前候选版本：`1.1.0-beta.2`，等待用户确认后再发布 `1.1.0`
- 最新 Git 标签：`v1.0.1`
...
- 最近完整验证：两颗芯片和全部封装数据校验通过；QEI 完整性、工程操作、撤销/重做、日间/夜间布局、v3/v4 导入、桌面保存桥接和关闭重开恢复通过；beta.2 文件夹版的真实键盘标签/备注输入和单一左侧滚动条通过
- 当前候选产物：`outputs/mspm0g3519-pin-planner.html`、`outputs/MSPM0-Pin-Planner-1.1.0-beta.2-Folder/`
